...
const App = () => {
  ...
  // Main site
  return (
    <div className="bg-gradient-to-br from-gray-900 via-gray-900 to-indigo-900">
        ...
        >
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
              We are pioneers in AI agent technology, creating intelligent
              solutions that understand, learn, and adapt to transform how
              businesses operate. Our cutting-edge AI agents provide seamless
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              <div className="bg-white/5 backdrop-blur-sm p-8 rounded-lg border border-white/10 hover:border-blue-400/30 transition-colors duration-300">
                ...
                <p className="text-gray-300">
                  AI agents that automate complex workflows and decision-making
                  processes with human-like intelligence.
                </p>
              </div>
              <div className="bg-white/5 backdrop-blur-sm p-8 rounded-lg border border-white/10 hover:border-purple-400/30 transition-colors duration-300">
                ...
                <p className="text-gray-300">
                  Natural language processing agents for customer service,
              ...
              <div className="bg-white/5 backdrop-blur-sm p-8 rounded-lg border border-white/10 hover:border-cyan-400/30 transition-colors duration-300">
                ...
                <p className="text-gray-300">
                  AI-powered data analysis and insights generation for informed
                  business decisions.
                </p>
              </div>
            </div>
        ...
        >
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-gray-300 mb-12 max-w-2xl mx-auto">
              Transform your business with our AI agents. Let's discuss how we
              can help you automate, optimize, and innovate with intelligent
              technology.
            </p>
